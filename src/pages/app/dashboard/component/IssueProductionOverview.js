...
const IssueProductionOverview = () => {
   // console.log('data-SSS', data)
   const [data, setData] = useState(false)
   const [spinner, setSpinner] = useState(true);

   const fetchDataIssueProductionOverview = async () => {
      try {
         await axios.get(`${BaseURL}/dashboard/issue-produksi-overview`)
            .then(res => {
   ...
   useEffect(() => {
      fetchDataIssueProductionOverview()
   }, [])
   ...
   return (
      <React.Fragment>
         ...
         <div className="card-title-group align-start mb-2">
            <CardTitle>
               <h6 className="title">Issue Produksi Overview</h6>
            </CardTitle>
...
export default IssueProductionOverview;